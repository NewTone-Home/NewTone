...
export const UI_TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  ja: {
    ...
    'lang.en': '英語',
    'lang.ja': '日本語',
    'route.main.label': '本筋・合',
    'route.jixiu.label': '姫修傑・札',
    'route.ruoyu.label': '若雨・筮',
    'route.yunling.label': '雲霊・笺',
    'route.zhangzhe.label': '姫承淵・蔵',
    'read.back': '選角に戻る',
    'read.fontSize': '文字サイズ',
    'tool.font': '字',
    'tool.theme': '表示',
