...
export const UI_TRANSLATIONS: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'lang.en': '英文',
    'lang.ja': '日文',
    'route.jixiu.label': '修杰·札',
    'route.ruoyu.label': '若雨·筮',
    'route.yunling.label': '云灵·笺',
    'route.chengyuan.label': '姬承渊·藏',
    'read.back': '返回选角',
    'read.fontSize': '字号',
    'tool.font': '字',
    'tool.theme': '主题',
  ...
  en: {
    ...
    'lang.en': 'English',
    'lang.ja': 'Japanese',
    'route.jixiu.label': 'Ji Xiu · Letter',
    'route.ruoyu.label': 'Ruo Yu · Divination',
    'route.yunling.label': 'Yun Ling · Note',
  ...
  ja: {
    ...
    'lang.en': '英語',
    'lang.ja': '日本語',
    'route.jixiu.label': '姫修傑・札',
    'route.ruoyu.label': '若雨・筮',
    'route.yunling.label': '雲霊・笺',
    'route.chengyuan.label': '姫承淵・蔵',
    'read.back': '選角に戻る',
    'read.fontSize': '文字サイズ',
    'tool.font': '字',
    'tool.theme': '表示',
