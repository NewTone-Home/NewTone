...
走到路口时，他掏出手机，发了一条消息.`,
    ...
    'read.sealed.message': '缄者，慎言也。时机未至，此卷不可阅。',
  },
  en: {
...
As he reached the intersection, he took out his phone and sent a message.`,
    ...
    'read.sealed.message': 'To seal is to silence. The time has not come; this volume may not be read.',
  },
  ja: {
    'app.title': '星間書庫',
...
交差点に辿り着いた時、彼は携帯を取り出し、一通のメッセージを送信した。`,
    ...
    'read.sealed.message': '缄とは、慎みて言わざるなり。時いまだ至らず、この巻読むべからず。',
  },
};
